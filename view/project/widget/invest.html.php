...
<button type="submit" class="btn btn-default pay-cash" name="method"  value="cash">CASH</button>
<?php endif; ?>
<button type="submit" class="btn pay-tpv" name="method"  value="tpv">TPV</button>
