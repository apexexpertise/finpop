...
<div class="widget project-message">
    ...
    <h<?php echo $level ?> class="title"> <i class="fa fa-comment-o margin-right border-circle"></i><?php echo Text::get('project-messages-send_direct-header'); ?></h<?php echo $level ?>>
