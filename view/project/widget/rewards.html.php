...
<div class="widget project-rewards collapsable" id="project-rewards">
    ...
    <div class="individual">
        ...
        <li class="<?php echo $individual->icon ?>">
			...
			<div class="investors">
			<a  class="btn btn-primary collab" href="/project/<?php echo $project->id; ?>/invest?amount=<?php echo amount_format($individual->amount) ?>" class="button violet">Obtiens-le!</a></div>
        </li>
        <?php endforeach ?>
    ...
    <a class="more" href="/project/<?php echo $project->id; ?>/rewards"><i class="fa fa-caret-square-o-right margin-right"></i><?php echo Text::get('regular-see_more'); ?></a>
