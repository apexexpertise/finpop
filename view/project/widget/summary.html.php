...
<!--        <h<?php echo $level + 1?>><?php # echo Text::get('overview-field-description'); ?></h<?php echo $level + 1?>>         -->
    ...
    <div class="about">
        <h<?php echo $level + 1?>><i class="fa fa-paw margin-right border-circle"></i><?php echo Text::get('overview-field-about'); ?></h<?php echo $level + 1?>>
    ...
    <div class="motivation">
        <h<?php echo $level + 1?>><i class="fa fa-heart-o margin-right border-circle"></i><?php echo Text::get('overview-field-motivation'); ?></h<?php echo $level + 1?>>
    ...
    <div class="goal">
        <h<?php echo $level + 1?>><i class="fa fa-crosshairs margin-right border-circle"></i><?php echo Text::get('overview-field-goal'); ?></h<?php echo $level + 1?>>
    ...
    <div class="related">
        <h<?php echo $level + 1?>><i class="fa fa-users margin-right border-circle"></i><?php echo Text::get('overview-field-related'); ?></h<?php echo $level + 1?>>
