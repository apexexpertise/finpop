...
<div class="widget project-support collapsable" id="project-support">
    ...
    <div class="buttons">
        ...
        <a class="button-cof animated tada" href="/project/<?php echo $project->id; ?>/invest"> <span><?php echo Text::get('regular-invest_it'); ?><p>&aacute; partir de 5 &euro;</p></span></a>
        <?php else : ?>
        <a class="btn btn-default" href="/project/<?php echo $project->id ?>/updates"><i class="fa fa-comments-o margin-right"></i><?php echo Text::get('regular-see_blog'); ?></a>
        <?php endif; ?>
        <a class="more" href="/project/<?php echo $project->id; ?>/needs"><i class="fa fa-caret-square-o-right margin-right"></i><?php echo Text::get('regular-see_more'); ?></a>
    </div>
