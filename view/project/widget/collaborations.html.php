...
<div class="widget project-collaborations collapsable" id="project-collaborations">
    ...
    <div class="buttons">
      	<a class="btn btn-success collab" href="/project/<?php echo $project->id; ?>/messages"><?php echo Text::get('regular-collaborate'); ?></a>
      	<a class="btn btn-default" href="/project/<?php echo $project->id; ?>/needs-non"><i class="fa fa-chevron-circle-right" style="font-size: 14px;padding: 0 4px;"></i><?php echo Text::get('regular-see_more'); ?></a>
    </div>
