...
<div id="project-steps">
	...
	<fieldset>
		<div class="steps">
			<ul>
				<li <?php if ($this['step'] === 'userProfile') echo ' class="current"';  ?>><button type="submit" name="view-step-userProfile"
						value="<?php echo Text::get('step-1'); ?>"><div></div><strong class="number">1</strong><?php echo Text::get('step-1'); ?>
                        
					</button>
				
				</li>
				<li <?php if ($this['step'] === 'userPersonal') echo ' class="current"';  ?>><button type="submit" name="view-step-userPersonal"
						value="<?php echo Text::get('step-2'); ?>"><div></div><strong class="number">2</strong><?php echo Text::get('step-2'); ?>
                        
					</button></li>
				<li <?php if ($this['step'] === 'overview') echo ' class="current"';  ?>>
					<button type="submit" name="view-step-overview"
						value="<?php echo Text::get('step-3'); ?>"> <div></div><strong class="number">3</strong><?php echo Text::get('step-3'); ?>
                           
					</button>
				</li>
				<li <?php if ($this['step'] === 'costs') echo ' class="current"';  ?>>
					<button type="submit" name="view-step-costs"
						value="<?php echo Text::get('step-4'); ?>"><div></div><strong class="number">4</strong><?php echo Text::get('step-4'); ?>
                            
					</button>
				</li>
				<li <?php if ($this['step'] === 'rewards') echo ' class="current"';  ?>>
					<button type="submit" name="view-step-rewards"
						value="<?php echo Text::get('step-5'); ?>"><div></div><strong class="number">5</strong><?php echo Text::get('step-5'); ?>
                            
					</button>
				</li>
				<li <?php if ($this['step'] === 'supports') echo ' class="current"';  ?>>
					<button type="submit" name="view-step-supports"
						value="<?php echo Text::get('step-6'); ?>"><div></div><strong class="number">6</strong><?php echo Text::get('step-6'); ?>
                            
					</button>
				</li>
				<li <?php if ($this['step'] === 'preview') echo ' class="current"';  ?>>
					<button type="submit" name="view-step-preview"
						value="<?php echo Text::get('step-7'); ?>"><strong class="number">7</strong><?php echo Text::get('step-7'); ?>
