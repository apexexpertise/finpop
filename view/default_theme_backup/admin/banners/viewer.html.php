    ...
    <form id="filter-form" action="/admin/accounts/viewer" method="get">
        <div style="float:left;margin:5px;">
            ...
            <select id="type-filter" name="type">
                <option value="invest"<?php if ($type == 'invest') echo ' selected="selected"';?>><?php echo Text::_("Contributions"); ?></option>
                <option value="execute"<?php if ($type == 'execute') echo ' selected="selected"';?>><?php echo Text::_("Frais"); ?></option>
                <option value="verify"<?php if ($type == 'verify') echo ' selected="selected"';?>><?php echo Text::_("Contrôles"); ?></option>
                <option value="daily"<?php if ($type == 'daily') echo ' selected="selected"';?>><?php echo Text::_("Avis"); ?></option>
                <option value="dopay"<?php if ($type == 'dopay') echo ' selected="selected"';?>><?php echo Text::_("Pages"); ?></option>
            </select>
        </div>
...
<?php if ($showlog) echo '<strong>'.Text::_("Archives").':</strong> ' . $file . '<br /><br />';
if (!empty($content)) echo nl2br($content); else echo Text::_("Pas trouv&eacute;"); ?>
<br /><br /><br />
