    ...
    <div class="widget user-message">
        ...
        <form method="post" action="/message/personal/<?php echo $user->id; ?>">
 		...
 		-->
            ...
            <button class="left btn btn-default lato" type="submit"><i class="fa fa-paper-plane margin-right"></i><?php echo Text::get('project-messages-send_message-button'); ?></button>
        </form>
