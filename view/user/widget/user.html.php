...
<div class="widget user collapsable">
    ...
    <div class="image">
        <?php if (!empty($user->avatar)): ?><img alt="<?php echo htmlspecialchars($user->name) ?>" src="<?php echo $user->avatar->getLink(80, 80, true); ?>" class="img-circle"/><?php endif ?>
    ...
    <dl>
        ...
        <dd class="links">
            <ul>
                ...
                <li><i class="fa fa-link margin-right"></i><a href="<?php echo htmlspecialchars($link->url) ?>"><?php echo htmlspecialchars($link->url) ?></a></li>
                <?php endforeach ?>
            </ul>
        </dd>
        <?php endif ?>
        ...
        <dd class="message"><i class="fa fa-comments-o margin-right"></i><a href="/user/profile/<?php echo htmlspecialchars($user->id) ?>/message"><?php echo Text::get('regular-send_message')?></a></dd>


    </dl>

    <a class="button aqua profile" href="/user/<?php echo $user->id; ?>"><i class="fa fa-caret-square-o-right margin-right"></i><?php echo Text::get('profile-widget-button'); ?></a>
