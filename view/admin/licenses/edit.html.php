...
<div class="widget board">
    <form method="post" action="/admin/licenses">
        ...
        <label for="license-group"><?php echo Text::_("Groupe:"); ?></label><br />
        <select id="license-group" name="group">
            <option value=""><?php echo Text::_("Aucun"); ?></option>
...
<br />
        <label for="license-name">Nom:</label><br />
        <input type="text" name="name" id="license-name" value="<?php echo $this['license']->name; ?>" />
<br />
        <label for="license-description">Text Infobulle:</label><br />
...
<br />
        ...
        <input type="submit" name="save" value="<?php echo Text::_("Enregistrer"); ?>" />
    </form>
