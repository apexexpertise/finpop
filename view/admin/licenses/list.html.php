...
<div class="widget board">
    <form id="filter-form" action="/admin/licenses" method="get">
        <label for="group-filter"><?php echo Text::_("Afficher par groupe:"); ?></label>
        <select id="group-filter" name="group" onchange="document.getElementById('filter-form').submit();">
            <option value=""><?php echo Text::_("Tout les groupes"); ?></option>
...
<!--                                <td> Remove </td> -->
        ...
        <tbody>
            ...
            <tr>
                <td><a href="/admin/licenses/edit/<?php echo $license->id; ?>">[<?php echo Text::_("Editer"); ?>]</a></td>
                ...
                <?php if ($translator) : ?>
                <td><a href="/translate/license/edit/<?php echo $license->id; ?>" >[<?php echo Text::_("Traduire"); ?>]</a></td>
                <?php endif; ?>
            </tr>
            <?php endforeach; ?>
        </tbody>
