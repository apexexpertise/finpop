    ...
    foreach ($post->gallery as $image) {
        $images[] = array(
            ...
            'html'  => is_object($image) ?
                       $image . '<img src="'.SRC_URL.'/image/'.$image->id.'/128/128" alt="'.Text::_("Imagen").'" /><button class="image-remove weak" type="submit" name="gallery-'.$image->id.'-remove" title="'.Text::_("Supprimer l'image").'" value="remove"></button>' :
                       ''
        );
    ...
    <?php echo new SuperForm(array(
        ...
        'elements'      => array(
            ...
            'date' => array(
                'type'      => 'datebox',
                'required'  => true,
                'title'     => Text::_("Date de publication"),
                'hint'      => Text::get('tooltip-updates-date'),
                'size'      => 8,
                'value'     => $post->date
            ),
            'allow' => array(
                'title'     => Text::_("Autoriser les commentaires"),
                'type'      => 'slider',
                'options'   => $allow,
            ...
            'footer' => array(
                'title'     => Text::_("Lien en bas de page"),
                'type'      => 'slider',
                'options'   => $allow,
                'class'     => 'currently cols_' . count($allow),
