...
?>
<div>
    <p>Rapport d'examen des projets '<?php echo $review->name; ?>' de <?php echo $review->owner_name; ?></p>
    <p>Modification du projet atteint le <strong><?php echo $review->progress; ?>%</strong>et le score moyen en revue: <span id="total-score"><?php echo $review->score . '/' . $review->max; ?></span></p>
</div>
...
<div class="widget">
    ...
    <p>
        <strong><?php echo $user_data->name ?></strong> accorde des points pour:<br />
        <blockquote>
