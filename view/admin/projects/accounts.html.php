...
?>
<div class="widget">
    <p>Vous avez besoin d'un projet pour avoir un compte PayPal pour ex&eacute;cuter les charges. Le compte bancaire n'a que les informations dans le même environnement, mais elle ne s'utilise pas dans un processus public de ce système.</p>
    ...
    <p>
        <label for="account-bank_owner">Le titulaire du compte bancaire:</label><br />
