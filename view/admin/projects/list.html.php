    ...
    <table>
        ...
        <tbody>
            <tr>
                ...
                <td style="text-align: right;"><?php echo \amount_format($project->mincost).'â‚¬'; ?></td>
                <td style="text-align: right;"><?php echo \amount_format($project->maxcost).'â‚¬'; ?></td>
            </tr>
            <tr>
                <td colspan="7"><?php 
                    if ($project->status < 3)  echo "Information <strong>{$project->progress}%</strong>";
                    if ($project->status == 3 && $project->round > 0) echo "Nous sommes {$project->days} jour de la {$project->round}eme tour.&nbsp;&nbsp;&nbsp;<strong>Obtenu:</strong> ".\amount_format($project->invested)."â‚¬&nbsp;&nbsp;&nbsp;<strong>Cofinanceur:</strong> {$project->num_investors}&nbsp;&nbsp;&nbsp;<strong>Colabrateur:</strong> {$project->num_messegers}"; 
                ?></td>
            </tr>
            <tr>
                <td colspan="7">
