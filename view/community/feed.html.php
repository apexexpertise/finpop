...
?>
<link rel="stylesheet" href="../view/css/timeline/reset.css"> <!-- CSS reset -->
<link rel="stylesheet" href="../view/css/timeline/style.css"> <!-- Resource style -->
<script src="../view/js/timeline/modernizr.js"></script> <!-- Modernizr -->
<section id="cd-timeline" class="cd-container">
		
		<?php 
		foreach ($items['finpop'] as $item) :
			echo Feed::subItemTimeLine($item);
         endforeach; ?>         
	</section> <!-- cd-timeline -->
	<script src="../view/js/timeline/main.js"></script> <!-- Resource jQuery -->
<!-- 
