                    ...
                    ?>
                        <li class="<?php if($cnt < 3) echo " bordertop"?>">
                            <div class="user">
                                ...
                                <div class="avatar"><a href="/user/<?php echo htmlspecialchars($mate->user) ?>"><img src="<?php echo $mate->avatar->getLink(60, 60, true) ?>" /></a></div>
                                <h4><a href="/user/<?php echo htmlspecialchars($mate->user) ?>"><?php echo htmlspecialchars($mate->name) ?></a></h4>
                                <span class="projects"><i class="fa fa-cogs margin-rigt margin-right"></i><?php echo Text::get('regular-projects'); ?> (<?php echo $mate->projects ?>)</span>
                                <span class="invests"><i class="fa fa-thumbs-o-up margin-right"></i><?php echo Text::get('regular-investing'); ?> (<?php echo $mate->invests ?>)</span>
                                <p class="profile"><i class="fa fa-user margin-right"></i><a href="/user/profile/<?php echo htmlspecialchars($mate->user) ?>"><?php echo Text::get('profile-widget-button'); ?></a> </p>
                                <p class="contact"><i class="fa fa-paper-plane-o margin-right"></i><a href="/user/profile/<?php echo htmlspecialchars($mate->user) ?>/message"><?php echo Text::get('regular-send_message'); ?></a></p>
                            </div>
                        </li>
                    <?php 
                    $cnt ++;
