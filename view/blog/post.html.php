...
?>
        ...
        <div id="post-gallery<?php echo $post->id ?>" class="post-gallery">
			<div class="post-gallery-container">
				...
				<div class="gallery-image gallery-post<?php echo $post->id ?>" id="gallery-post<?php echo $post->id ?>-<?php echo $i ?>">
					<img src="<?php echo $image->getLink(710, 381); ?>" alt="<?php echo $post->title; ?>" />
				</div>
				<?php $i++; endforeach; ?>
			</div>
	...
	<blockquote>
        <?php echo $post->text; ?>
        <?php if ($this['show'] == 'list') : ?><div class="read_more"><i class="fa fa-hand-o-right margin-right"></i><a href="<?php echo $url.$post->id; ?>"><?php echo Text::get('regular-read_more') ?></a></div><?php endif ?>
    </blockquote>
