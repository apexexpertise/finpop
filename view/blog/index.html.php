 ...
 *
 */
use Goteo\Library\Text, Goteo\Core\View, Goteo\Model\Blog\Post;
...
<div class="container">
	<div class="row clearfix">
		<div class="col-md-8 column id=" main" class="threecols">
...
while ( $post = $pagedResults->fetchPagedRow () ) :
						...
						<li class="twitter"><a
							href="<?php echo htmlspecialchars($twitter_url) ?>"
							target="_blank"><?php echo Text::get('regular-twitter'); ?></a></li>
						<li class="facebook"><a
							href="<?php echo htmlspecialchars($facebook_url) ?>"
							target="_blank"><?php echo Text::get('regular-facebook'); ?></a></li>
					</ul>  -->
					<div class="comments-num">
						<a href="/blog/<?php echo $post->id; ?>"><i class="fa fa-comment-o margin-right"></i><?php echo $post->num_comments > 0 ? $post->num_comments . ' ' .Text::get('blog-comments') : Text::get('blog-no_comments'); ?></a>
					</div>
				</div>
					<?php endwhile; ?>
                    <ul id="pagination">
...
echo new View ( 'view/blog/post.html.php', $this );
		...
		<div class="col-md-4 column id="blog-sidebar">
